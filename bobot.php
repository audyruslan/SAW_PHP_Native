...
if (isset($_POST['simpan'])) {
    ...
    alert('jumlah bobot tidak sama dengan 1. ulangi penginputan bobot !');
                ...
                $sql = "INSERT INTO tb_kriteriasaw(pendapatan_ortu,tanggungan_ortu,pengeluaran_ortu,ipk,semester,tingkahlaku,keaktifanorganisasi)
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="dataMahasiswa" class="table table-bordered table-hover">
                                ...
                                <?php
                                $i = 1;
                                $sql = mysqli_query($conn, "SELECT * FROM tb_kriteriasaw");
