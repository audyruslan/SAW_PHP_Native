<?php
$title = "Administrator - SAW Beasiswa";
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">
                <?php
                $mhs = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM tb_kriteriasaw"));
                ?>
                <?= $mhs; ?>
                <small>Data</small>
              </span>
      ...
      <div class="row">
        <div class="col-12">
          <div class="callout callout-danger">
            <h5>
              <i class="fas fa-bullhorn"></i> Sistem Pendukung Keputusan dengan Metode SAW!
            </h5>
